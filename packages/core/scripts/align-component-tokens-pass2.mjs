...
const colorMap = {
  ...
  "core-button-primary-bg": "brand-background-strong",
  "core-button-primary-text": "brand-text-primary-oncolor",
  "core-button-primary-bgHover": "brand-background-hover",
  "core-button-primary-bgActive": "brand-background-active",
  "core-color-action-primary-disabled-bg": "brand-background-disabled-strong",
  "core-color-action-primary-disabled-border": "brand-borders-primary-disabled",
