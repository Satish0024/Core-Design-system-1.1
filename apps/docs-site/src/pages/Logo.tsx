...
function InteractiveLogoPanel({ title, darkImg, lightImg, height }: { title: string, darkImg: string, lightImg: string, height: number }) {
  ...
  return (
    <div style={{ position: "relative", borderRadius: "var(--core-radius-lg)", overflow: "hidden", border: "1px solid rgba(128,128,128,0.15)", background: "var(--core-color-surface-default)" }}>
      {/* Absolute Toggle Switch */}
      <div style={{ position: "absolute", top: 20, right: 24, display: "flex", alignItems: "center", gap: "var(--core-space-3)", zIndex: 10 }}>
...
function LogoAnatomy() {
  ...
  return (
    <div style={{ position: "relative", padding: "var(--core-space-20) var(--core-space-10) var(--core-space-10)", background: "var(--core-color-surface-hover)", borderRadius: "var(--core-radius-lg)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", border: "1px solid rgba(128,128,128,0.15)", minHeight: 380 }}>
      {/* Orientation Toggle Switch */}
      <div style={{ position: "absolute", top: 20, right: 24, display: "flex", alignItems: "center", gap: "var(--core-space-2)", zIndex: 10 }}>
        <button
          type="button"
          ...
          style={{
            ...
            color: orientation === "horizontal" ? "var(--core-color-text-inverse)" : "var(--core-color-text-secondary)",
        ...
        <button
          ...
          style={{
            ...
            color: orientation === "vertical" ? "var(--core-color-text-inverse)" : "var(--core-color-text-secondary)",
            fontSize: "var(--core-font-size-xs)",
            fontWeight: 600,
            cursor: "pointer",
            transition: "all 0.2s"
      ...
      {orientation === "horizontal" ? (
        ...
        <div style={{ position: "relative", border: "1px solid var(--core-color-brand-400)", background: "rgba(0,82,204,0.06)", display: "inline-flex" }}>
          ...
          {/* Labels & Lines */}
          {/* Top label (4) */}
          <div style={{ position: "absolute", top: -2, left: -24, background: "var(--core-color-success-600)", color: "var(--core-color-text-inverse)", fontSize: "var(--typography-font-size-xs)", fontWeight: "bold", padding: "var(--core-space-1) var(--core-space-1)", borderRadius: "var(--core-radius-xs)", lineHeight: 1 }}>4</div>
          <div style={{ position: "absolute", top: 2, left: -9, width: 8, height: 1, background: "var(--core-color-success-600)" }}></div>
          <div style={{ position: "absolute", top: 2, left: -2, width: 1, height: 32, background: "var(--core-color-success-600)", opacity: 0.5 }}></div>

          {/* Left label (8) */}
          <div style={{ position: "absolute", top: -26, left: 4, background: "var(--core-color-success-600)", color: "var(--core-color-text-inverse)", fontSize: "var(--typography-font-size-xs)", fontWeight: "bold", padding: "var(--core-space-1) var(--core-space-1)", borderRadius: "var(--core-radius-xs)", lineHeight: 1, transform: "translateX(-50%)" }}>8</div>
          <div style={{ position: "absolute", top: -12, left: 4, width: 1, height: 10, background: "var(--core-color-success-600)" }}></div>
          <div style={{ position: "absolute", top: -12, left: 0, width: 18, height: 1, background: "var(--core-color-success-600)", opacity: 0.5 }}></div>

          {/* Right label (8) */}
          <div style={{ position: "absolute", top: -26, right: 4, background: "var(--core-color-success-600)", color: "var(--core-color-text-inverse)", fontSize: "var(--typography-font-size-xs)", fontWeight: "bold", padding: "var(--core-space-1) var(--core-space-1)", borderRadius: "var(--core-radius-xs)", lineHeight: 1, transform: "translateX(50%)" }}>8</div>
          <div style={{ position: "absolute", top: -12, right: 4, width: 1, height: 10, background: "var(--core-color-success-600)" }}></div>
          <div style={{ position: "absolute", top: -12, right: 0, width: 18, height: 1, background: "var(--core-color-success-600)", opacity: 0.5 }}></div>
          
          {/* Bottom label (4) */}
          <div style={{ position: "absolute", bottom: -2, left: -24, background: "var(--core-color-success-600)", color: "var(--core-color-text-inverse)", fontSize: "var(--typography-font-size-xs)", fontWeight: "bold", padding: "var(--core-space-1) var(--core-space-1)", borderRadius: "var(--core-radius-xs)", lineHeight: 1 }}>4</div>
          <div style={{ position: "absolute", bottom: 2, left: -9, width: 8, height: 1, background: "var(--core-color-success-600)" }}></div>
          <div style={{ position: "absolute", bottom: -30, left: -2, width: 1, height: 32, background: "var(--core-color-success-600)", opacity: 0.5 }}></div>

          {/* The actual logo */}
          <div style={{ padding: "var(--core-space-1) var(--core-space-2)" }}>
        ...
        <div style={{ position: "relative", border: "1px solid var(--core-color-brand-400)", background: "rgba(0,82,204,0.06)", display: "inline-flex" }}>
          ...
          {/* Center gap label (8) */}
          <div style={{ position: "absolute", top: 56, right: -24, background: "var(--core-color-success-600)", color: "var(--core-color-text-inverse)", fontSize: "var(--typography-font-size-xs)", fontWeight: "bold", padding: "var(--core-space-1) var(--core-space-1)", borderRadius: "var(--core-radius-xs)", lineHeight: 1 }}>8</div>
          <div style={{ position: "absolute", top: 64, right: -8, width: 8, height: 1, background: "var(--core-color-success-600)" }}></div>

          {/* Vertical Stacked Logo Content */}
          <div style={{ padding: "var(--core-space-1) var(--core-space-4)", display: "flex", flexDirection: "column", alignItems: "center", minWidth: 110 }}>
            {/* Symbol on Top */}
            ...
            {/* Wordmark beneath */}
            <span style={{ display: "block", fontSize: "var(--core-font-size-lg)", fontWeight: 700, letterSpacing: "0.08em", color: "#292670", lineHeight: 1, margin: 0 }}>
              CORE
            </span>
          </div>
        </div>
  ...
  return (
    <div style={{ maxWidth: 1024, margin: "0 auto", padding: "var(--core-space-5)" }}>
      <div style={{ textAlign: "center", marginBottom: "var(--core-space-16)", marginTop: "var(--core-space-10)" }}>
        <h1 style={{ fontSize: "var(--core-font-size-5xl)", fontWeight: 700, letterSpacing: "-0.06em", margin: "0 0 var(--core-space-4) 0", color: "var(--core-color-text-primary)", lineHeight: 1.1 }}>
          Logo
        </h1>
        ...
        {sections.map((s) => (
          <div key={s.id} id={s.anchorId} className="docs-section" style={{ display: "flex", flexDirection: "column", gap: "var(--core-space-10)", position: "relative" }}>
            ...
            <div style={{ paddingTop: "var(--core-space-8)" }}>
              ...
              <h2 style={{ fontSize: "var(--core-font-size-5xl)", fontWeight: 500, letterSpacing: "-0.04em", margin: 0 }}>{s.title}</h2>
            </div>
            <div>
              {s.content}
            </div>
