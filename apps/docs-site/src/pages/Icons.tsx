      ...
      <DocsSectionList>
        <DocsSection anchorId="fontawesome-pro" title="Get Font Awesome 6 Pro">
          <div className="site-panel">
            <p style={{ margin: "0 0 var(--core-space-4)", fontSize: "var(--core-font-size-sm)", color: "var(--site-text-dim)", lineHeight: 1.7 }}>
            ...
            <div style={{ display: "flex", gap: "var(--core-space-3)", flexWrap: "wrap", marginBottom: "var(--core-space-4)" }}>
        ...
        <DocsSection anchorId="sizing" title="Sizing">
          <div className="site-panel site-panel--flush">
            <div className="preview-surface" data-theme="core" data-mode="light" style={{ background: "var(--core-color-bg-page)" }}>
              <div style={{ textAlign: "center" }}><Icon name="fa-solid fa-piggy-bank" size="sm" /><div style={{ fontSize: "var(--typography-font-size-xs)", marginTop: "var(--core-space-2)", color: "var(--core-color-text-tertiary)" }}>sm · 16px</div></div>
              <div style={{ textAlign: "center" }}><Icon name="fa-solid fa-piggy-bank" size="md" /><div style={{ fontSize: "var(--typography-font-size-xs)", marginTop: "var(--core-space-2)", color: "var(--core-color-text-tertiary)" }}>md · 20px</div></div>
              <div style={{ textAlign: "center" }}><Icon name="fa-solid fa-piggy-bank" size="lg" /><div style={{ fontSize: "var(--typography-font-size-xs)", marginTop: "var(--core-space-2)", color: "var(--core-color-text-tertiary)" }}>lg · 24px</div></div>
            </div>
          </div>
        </DocsSection>
        ...
        <DocsSection anchorId="interactive-icons" title="Interactive icons">
          <div className="site-panel site-panel--flush">
            <div className="preview-surface" data-theme="core" data-mode="light" style={{ background: "var(--core-color-bg-page)" }}>
              ...
              <span style={{ fontSize: "var(--core-font-size-sm)", color: "var(--core-color-text-primary)" }}>
                <Icon name="fa-solid fa-circle-check" size="sm" label="Verified" style={{ color: "var(--core-color-status-success-text)", marginRight: "var(--core-space-1)" }} />
                Identity verified
              </span>
            </div>
          </div>
